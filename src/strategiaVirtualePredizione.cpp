...
StrategiaVirtualePredizione::StrategiaVirtualePredizione(epever *dev,Tempo *t,GreenPlantModel *m): Strategia::Strategia(dev){
    time=t;
    attivo=true;
    model=m;
...
int StrategiaVirtualePredizione::strategia(float batteryCharge){
